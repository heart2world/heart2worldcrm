...
class ExcelController extends BaseController {
	...
	public function customer_import(){
		$data = $this->importExecl('C:\Users\Administrator\Desktop\excel\cus.xlsx');
		//用户信息
		...
		foreach ($data as $key => $value) {
			...
			$one_data['remark'] = $status_data[$value['Z']];
	...
	public function follow_import(){
		$data = $this->importExecl('C:\Users\Administrator\Desktop\客户11-05\IKCRM_revisit_logs_20181105-11-04跟进.xlsx');
		//客户信息
